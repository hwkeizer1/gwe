...
@Component
public class MeasurementUsageTableView {

	private final MeasurementService measurementService;

	private TableView<Measurement> table;

	public MeasurementUsageTableView(MeasurementService measurementService) {
		...
		colBeginDate.setCellValueFactory(p -> new ReadOnlyObjectWrapper<>(p.getValue().getStartDate()));
		colEndDate.setCellValueFactory(p -> new ReadOnlyObjectWrapper<>(p.getValue().getEndDate()));
